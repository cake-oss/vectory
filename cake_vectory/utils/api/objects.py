...
class ObjectsClient(WeaviateClient):
    ...
    def get_objects(
        ...
        """
        params = {"class": class_name, "limit": limit, "offset": offset}
    ...
    def get_object(
        self, class_name: str, object_id: str, tenant: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def get_collection_count(
        self, class_name: str, tenant: Optional[str] = None
    ) -> int:
        ...
        try:
            ...
            class_data = (
                response.get("data", {}).get("Aggregate", {}).get(class_name, [])
            )
